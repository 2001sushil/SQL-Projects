-- SQL Analysis Ayodhya Ram Temple 
CREATE DATABASE Sushil;
USE sushil;
...
-- Populating data into Deity table
INSERT INTO Deity (DeityID, Name, Description) VALUES
...
-- Populating the data into temple table
INSERT INTO Temple (TempleID, Name, Location, ConstructionStartDate, ExpectedCompletionDate) VALUES
(1, 'Ram Mandir', 'Ayodhya, Uttar Pradesh, India', '2020-03-01', '2024-01-22');
SELECT * FROM Temple;

-- Populating the data into construction phase table
INSERT INTO ConstructionPhase (PhaseID, TempleID, PhaseName, StartDate, CompletionDate) VALUES
...
-- Populating the data into architecture table
INSERT INTO Architecture (ArchitectureID, TempleID, ArchitectName, Description) VALUES
...
-- Populating the data into donations table
INSERT INTO Donations (DonationID, DonorName, Amount, DonationDate, TempleID) VALUES
...
-- Populating the data into Events table
INSERT INTO Events (EventID, EventName, EventDate, Description) VALUES
...
-- Populating the data into TempleEvents table
...
SELECT * FROM Temple;
-- Q.2 
SELECT Name, Description FROM Deity WHERE DeityID = 1;
...
SELECT * FROM Events; 
-- Q.7 
SELECT * FROM Donations WHERE Amount>=50000;  
 -- Q.8
 SELECT StartDate, CompletionDate FROM ConstructionPhase;
 -- Q.9 
 SELECT * FROM Donations WHERE DonationDate >= '2021-06-01';
-- Q.10
SELECT SUM(Amount) AS Total_Amount FROM Donations WHERE TempleID=1;  
